...
export function InfoBanner() {
  return (
    <div className="flex items-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-r from-blue-50 via-blue-50 to-blue-200/70 p-4 dark:from-blue-950/50 dark:via-blue-950/40 dark:to-blue-900/40">
